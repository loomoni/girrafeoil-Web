...
<div class="row wrapper border-bottom white-bg page-heading" >
    <div class="col-lg-10 py-2">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong style="color: #04336b">Contact</strong>
            </li>
        </ol>
    </div>
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div>
                        <div class="row">
                            <div class="col-md-2">
                                <a  href="{{ url('admin/contact/create') }}"  class="btn btn-primary w-100">Add New</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php $count=0 ?>
                                    ...
                                    <?php $count++ ?>
                                        <tr>
                                            ...
                                            <td>{{ $data->phone }}</td>
                                            <td style="width: 11%">
                                                <a class="btn btn-primary btn-sm" href="{{ url('admin/contact/edit', $data->id) }}"><i class="fa fa-edit" ></i></a>
                                                <a data-toggle="modal" data-target="#delete{{ $data->id }}" class="btn btn-danger btn-sm text-white"><i class="fa fa-trash"></i></a>
                                            </td>
                                            {{-- @include('backend/Contact/modals/deleteAbout') --}}
                                        </tr>
                                    @endforeach
                            </tbody>
                        </table>
    ...
    {{-- @include('backend/Home/Contact/modals/addContact') --}}
