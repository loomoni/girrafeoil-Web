...
<main class="app-content">
    ...
    <div class="">
        <a class="btn btn-primary" href="{{ url('admin-home/sliders') }}"><i class="fa fa-edit"></i> Manage Slider</a>
    </div>
    <div class="row mt-2">
                    ...
                    <form method="POST" action=""  enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="profile" class="form-control @error('profile') is-invalid @enderror" type="file">
                                @error('profile')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
