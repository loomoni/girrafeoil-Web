...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Add Testimonials</h1>
        </div>
    ...
    <div>
        <a class="btn btn-primary back-btn" href="{{ url('admin/testimonials') }}"><i class="fa-solid fa-reply-all"></i>   Back</a>
    </div>
    <div class="row mt-2">
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Add New Testimonials</h3>
                <div class="tile-body">
