            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div>
                        <div class="row">
                            <div class="col-md-2">
                                <a  href="{{ url('admin/testimonials/create') }}"  class="btn btn-primary w-100">Add New</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php $count=0 ?>
                                    ...
                                    <?php $count++ ?>
                                        <tr>
                                            ...
                                            <td style="width: 11%">
                                                <a class="btn btn-primary btn-sm" href="{{ url('admin/testimonials/edit', $data->id) }}"><i class="fa fa-edit" ></i></a>
                                           ...
                                           <!-- Delete Modal -->
                                            <div class="modal fade" id="delete{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <form role="form" action="{{ url('admin/testimonials/delete', $data->id) }}" method="GET">
